...
public class DOMStreamReader implements XMLStreamReader, NamespaceContext {
    ...
    @Override
    public String getElementText() throws android.xml.stream.XMLStreamException {
 ...
 NS declarations using a NamespaceContext implementation instead.
    ...
    @Override
    public boolean hasNext() throws android.xml.stream.XMLStreamException {
    ...
    @Override
    public int nextTag() throws android.xml.stream.XMLStreamException {
        int eventType = next();
    ...
    public void require(int type, String namespaceURI, String localName)
        throws android.xml.stream.XMLStreamException
    {
        if (type != _state) {
