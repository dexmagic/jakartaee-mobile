...
import static android.jdk.xml.internal.JdkConstants.FQ_IS_STANDALONE;
import static android.jdk.xml.internal.JdkConstants.JDK_DEBUG_LIMIT;
import static android.jdk.xml.internal.JdkConstants.JDK_ENTITY_COUNT_INFO;
import static android.jdk.xml.internal.JdkConstants.JDK_EXTENSION_CLASSLOADER;
import static android.jdk.xml.internal.JdkConstants.JDK_EXT_CLASSLOADER;
import static android.jdk.xml.internal.JdkConstants.JDK_IS_STANDALONE;
import static android.jdk.xml.internal.JdkConstants.ORACLE_IS_STANDALONE;
import static android.jdk.xml.internal.JdkConstants.SP_IS_STANDALONE;
import static android.jdk.xml.internal.JdkConstants.SP_XSLTC_IS_STANDALONE;
import static android.jdk.xml.internal.JdkConstants.ORACLE_ENABLE_EXTENSION_FUNCTION;
import static android.jdk.xml.internal.JdkConstants.ORACLE_FEATURE_SERVICE_MECHANISM;
import static android.jdk.xml.internal.JdkConstants.SP_ENABLE_EXTENSION_FUNCTION;
import static android.jdk.xml.internal.JdkConstants.SP_ENABLE_EXTENSION_FUNCTION_SPEC;
import static android.jdk.xml.internal.JdkConstants.CDATA_CHUNK_SIZE;
import static android.jdk.xml.internal.JdkConstants.OVERRIDE_PARSER;
import static android.jdk.xml.internal.JdkConstants.RESET_SYMBOL_TABLE;
