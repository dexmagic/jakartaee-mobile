...
public class JdkXmlUtils {
     ...
     * Catalog features
     */
    public final static String USE_CATALOG = android.xml.XMLConstants.USE_CATALOG;
    ...
    public static void catalogFeaturesConfig2Config(XMLComponentManager config1,
        ...
        boolean useCatalog = config1.getFeature(android.xml.XMLConstants.USE_CATALOG);
        try {
    ...
    public static void catalogFeaturesConfig2Reader(XMLComponentManager config, XMLReader reader) {
        boolean supportCatalog = true;
        boolean useCatalog = config.getFeature(android.xml.XMLConstants.USE_CATALOG);
        try {
     ...
     * requested
     * <p>param useXMLReaderFactory a flag indicating when the XMLReader should be
