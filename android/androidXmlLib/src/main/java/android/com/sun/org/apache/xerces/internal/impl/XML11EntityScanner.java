...
public class XML11EntityScanner
    ...
    protected int scanContent(XMLString content) throws IOException {
        ...
        // normalize newlines
        if (normalizeNewlines(Constants.XML_VERSION_1_1, content, false, false, null)) {
            return -1;
        }
    ...
    protected int scanLiteral(int quote, XMLString content, boolean isNSURI)
        ...
        // normalize newlines
        if (normalizeNewlines(Constants.XML_VERSION_1_1, content, false, true, null)) {
            return -1;
        }
    ...
    protected boolean scanData(String delimiter, XMLStringBuffer buffer, int chunkLimit)
        ...
        do {
            ...
            // normalize newlines
            if (normalizeNewlines(Constants.XML_VERSION_1_1, buffer, true, false, XMLScanner.NameType.COMMENT)) {
                return true;
            }
