...
import android.com.sun.org.apache.xerces.internal.util.XMLAttributesIteratorImpl;
...
import android.com.sun.xml.internal.stream.dtd.DTDGrammarUtil;
...
public class XMLDocumentFragmentScannerImpl
    ...
    void checkDepth(String elementName) {
        fLimitAnalyzer.addValue(XMLSecurityManager.Limit.MAX_ELEMENT_DEPTH_LIMIT, elementName, fElementStack.fDepth);
        if (fSecurityManager.isOverLimit(XMLSecurityManager.Limit.MAX_ELEMENT_DEPTH_LIMIT,fLimitAnalyzer)) {
            ...
            reportFatalError("MaxElementDepthLimit", new Object[]{elementName,
                fLimitAnalyzer.getTotalValue(XMLSecurityManager.Limit.MAX_ELEMENT_DEPTH_LIMIT),
                fSecurityManager.getLimit(XMLSecurityManager.Limit.MAX_ELEMENT_DEPTH_LIMIT),
                "maxElementDepth"});
        }
    }
