...
package android.com.sun.org.apache.xerces.internal.impl.dv.xs;

import android.com.sun.org.apache.xerces.internal.impl.Constants;
import android.com.sun.org.apache.xerces.internal.impl.dv.DatatypeException;
import android.com.sun.org.apache.xerces.internal.impl.dv.InvalidDatatypeFacetException;
...
import android.com.sun.org.apache.xerces.internal.impl.dv.XSFacets;
import android.com.sun.org.apache.xerces.internal.impl.dv.XSSimpleType;
import android.com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression;
import android.com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols;
import android.com.sun.org.apache.xerces.internal.impl.xs.util.ObjectListImpl;
import android.com.sun.org.apache.xerces.internal.impl.xs.util.ShortListImpl;
...
import android.com.sun.org.apache.xerces.internal.xs.StringList;
import android.com.sun.org.apache.xerces.internal.xs.XSAnnotation;
import android.com.sun.org.apache.xerces.internal.xs.XSConstants;
import android.com.sun.org.apache.xerces.internal.xs.XSFacet;
import android.com.sun.org.apache.xerces.internal.xs.XSMultiValueFacet;
import android.com.sun.org.apache.xerces.internal.xs.XSNamespaceItem;
import android.com.sun.org.apache.xerces.internal.xs.XSObject;
import android.com.sun.org.apache.xerces.internal.xs.XSObjectList;
import android.com.sun.org.apache.xerces.internal.xs.XSSimpleTypeDefinition;
import android.com.sun.org.apache.xerces.internal.xs.XSTypeDefinition;
import android.com.sun.org.apache.xerces.internal.xs.datatypes.ObjectList;
...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    protected XSSimpleTypeDecl(XSSimpleTypeDecl base, String name, short validateDV,
        ...
        fVariety = XSSimpleTypeDefinition.VARIETY_ATOMIC;
        fValidationDV = validateDV;
        fFacetsDefined = XSSimpleTypeDefinition.FACET_WHITESPACE;
        if (validateDV == DV_ANYSIMPLETYPE ||
            ...
            fFixedFacet = XSSimpleTypeDefinition.FACET_WHITESPACE;
        }
    ...
    protected XSSimpleTypeDecl(String name, String uri, short finalSet, XSSimpleTypeDecl itemType, boolean isImmutable,
        ...
        fVariety = XSSimpleTypeDefinition.VARIETY_LIST;
        fItemType = itemType;
    ...
    protected XSSimpleTypeDecl(String name, String uri, short finalSet, XSSimpleTypeDecl[] memberTypes,
        ...
        fVariety = XSSimpleTypeDefinition.VARIETY_UNION;
    ...
    public short getVariety(){
        ...
        return fValidationDV == DV_ANYSIMPLETYPE ? XSSimpleTypeDefinition.VARIETY_ABSENT : fVariety;
    }
    ...
    public short getWhitespace() throws DatatypeException {
        if (fVariety == XSSimpleTypeDefinition.VARIETY_UNION) {
    ...
    public short getPrimitiveKind() {
        if (fVariety == XSSimpleTypeDefinition.VARIETY_ATOMIC && fValidationDV != DV_ANYSIMPLETYPE) {
    ...
    public XSSimpleTypeDefinition getItemType() {
        if (fVariety == XSSimpleTypeDefinition.VARIETY_LIST) {
            return fItemType;
        }
        else {
            // REVISIT: error situation. runtime exception?
    ...
    throws InvalidDatatypeFacetException {
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_LENGTH) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_LENGTH) == 0) {
                ...
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_LENGTH;
                if ((fixedFacet & XSSimpleTypeDefinition.FACET_LENGTH) != 0)
                    fFixedFacet |= XSSimpleTypeDefinition.FACET_LENGTH;
            }
        }
        // minLength
        if ((presentFacet & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_MINLENGTH) == 0) {
                ...
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_MINLENGTH;
                if ((fixedFacet & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0)
                    fFixedFacet |= XSSimpleTypeDefinition.FACET_MINLENGTH;
            }
        }
        // maxLength
        if ((presentFacet & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_MAXLENGTH) == 0) {
                ...
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_MAXLENGTH;
                if ((fixedFacet & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0)
                    fFixedFacet |= XSSimpleTypeDefinition.FACET_MAXLENGTH;
            }
        }
        // pattern
        if ((presentFacet & XSSimpleTypeDefinition.FACET_PATTERN) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_PATTERN) == 0) {
                ...
                if (regex != null) {
                    ...
                    fFacetsDefined |= XSSimpleTypeDefinition.FACET_PATTERN;
                    if ((fixedFacet & XSSimpleTypeDefinition.FACET_PATTERN) != 0)
                        fFixedFacet |= XSSimpleTypeDefinition.FACET_PATTERN;
                }
            }
        }
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_ENUMERATION) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_ENUMERATION) == 0) {
                ...
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_ENUMERATION;
                if ((fixedFacet & XSSimpleTypeDefinition.FACET_ENUMERATION) != 0)
                    fFixedFacet |= XSSimpleTypeDefinition.FACET_ENUMERATION;
            }
        }
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) == 0) {
                ...
                try {
                    ...
                    fFacetsDefined |= XSSimpleTypeDefinition.FACET_MAXINCLUSIVE;
                    if ((fixedFacet & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0)
                        fFixedFacet |= XSSimpleTypeDefinition.FACET_MAXINCLUSIVE;
                } catch (InvalidDatatypeValueException ide) {
                ...
                if (((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0)) {
                    if ((fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0) {
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) == 0) {
                ...
                try {
                    ...
                    fFacetsDefined |= XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE;
                    if ((fixedFacet & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0)
                        fFixedFacet |= XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE;
                } catch (InvalidDatatypeValueException ide) {
                    reportError(ide.getKey(), ide.getArgs());
                ...
                // check against fixed value in base
                if (((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0)) {
                    result = fDVs[fValidationDV].compare(fMaxExclusive, fBase.fMaxExclusive);
                    if ((fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0 && result != 0) {
                ...
                else if (((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0)) {
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) == 0) {
                ...
                try {
                    ...
                    fFacetsDefined |= XSSimpleTypeDefinition.FACET_MINEXCLUSIVE;
                    if ((fixedFacet & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0)
                        fFixedFacet |= XSSimpleTypeDefinition.FACET_MINEXCLUSIVE;
                } catch (InvalidDatatypeValueException ide) {
                    reportError(ide.getKey(), ide.getArgs());
                ...
                // check against fixed value in base
                if (((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0)) {
                    result = fDVs[fValidationDV].compare(fMinExclusive, fBase.fMinExclusive);
                    if ((fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0 && result != 0) {
                ...
                else if (((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)) {
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_MININCLUSIVE) == 0) {
                ...
                try {
                    ...
                    fFacetsDefined |= XSSimpleTypeDefinition.FACET_MININCLUSIVE;
                    if ((fixedFacet & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)
                        fFixedFacet |= XSSimpleTypeDefinition.FACET_MININCLUSIVE;
                } catch (InvalidDatatypeValueException ide) {
                    reportError(ide.getKey(), ide.getArgs());
                ...
                // check against fixed value in base
                if (((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)) {
                    if ((fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0) {
        ...
        if ((presentFacet & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_TOTALDIGITS) == 0) {
                ...
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_TOTALDIGITS;
                if ((fixedFacet & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0)
                    fFixedFacet |= XSSimpleTypeDefinition.FACET_TOTALDIGITS;
            }
        }
        // fractionDigits
        if ((presentFacet & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0) {
            if ((allowedFacet & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) == 0) {
                ...
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_FRACTIONDIGITS;
                if ((fixedFacet & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0)
                    fFixedFacet |= XSSimpleTypeDefinition.FACET_FRACTIONDIGITS;
            }
        }
        ...
        if(fFacetsDefined != 0) {
            ...
            if(((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH ) != 0 ) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0))
            {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0)) {
                reportError( "maxInclusive-maxExclusive", new Object[]{fMaxInclusive, fMaxExclusive, fTypeName});
            }

            // check 4.3.9.c1 error: minInclusive + minExclusive
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)) {
                reportError("minInclusive-minExclusive", new Object[]{fMinInclusive, fMinExclusive, fTypeName});
            }

            // check 4.3.7.c1 must: minInclusive <= maxInclusive
            if (((fFacetsDefined &  XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)) {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0)) {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0)) {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0) && ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)) {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0) &&
                    ((fFacetsDefined & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0)) {
            ...
            if((fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 ){
                if ((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0 &&
                ...
                if ((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 &&
                ...
                if ( (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 ) {
            ...
            if((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 || (fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0){
                if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0){
                    if ((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 && fBase.fLength < fMinLength) {
                    ...
                    if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 && fLength < fMinLength) {
                ...
                if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0){
                    if ((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 && fBase.fLength > fMaxLength) {
                    ...
                    if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 && fLength > fMaxLength) {
            ...
            if ( ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH ) != 0 ) ) {
                ...
                else if ( (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0 ) {
                    if ( (fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0 && fMinLength != fBase.fMinLength ) {
            ...
            if ( ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH ) != 0 ) && ((fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH ) != 0 )) {
            ...
            if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 ) {
                if ( (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 ){
                    if(( (fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 )&& fMaxLength != fBase.fMaxLength ) {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0)) {
                if ((( fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0)) {
                    if ((fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0 && fTotalDigits != fBase.fTotalDigits) {
            ...
            if (((fFacetsDefined & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0)) {
                if ((( fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0)) {
                    if (((fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0 && fFractionDigits != fBase.fFractionDigits) ||
            ...
            if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_WHITESPACE) != 0 && (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_WHITESPACE) != 0 ){
                if ( (fBase.fFixedFacet & XSSimpleTypeDefinition.FACET_WHITESPACE) != 0 &&  fWhiteSpace != fBase.fWhiteSpace ) {
        ...
        // inherit length
        if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) == 0  && (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 ) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_LENGTH;
            fLength = fBase.fLength;
            lengthAnnotation = fBase.lengthAnnotation;
        }
        // inherit minLength
        if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH) == 0 && (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0 ) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_MINLENGTH;
            fMinLength = fBase.fMinLength;
            minLengthAnnotation = fBase.minLengthAnnotation;
        }
        // inherit maxLength
        if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) == 0 &&  (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 ) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_MAXLENGTH;
            fMaxLength = fBase.fMaxLength;
            maxLengthAnnotation = fBase.maxLengthAnnotation;
        }
        // inherit pattern
        if ( (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_PATTERN) != 0 ) {
            if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_PATTERN) == 0) {
                fFacetsDefined |= XSSimpleTypeDefinition.FACET_PATTERN;
                fPattern = fBase.fPattern;
                fPatternStr = fBase.fPatternStr;
                patternAnnotations = fBase.patternAnnotations;
        ...
        // inherit enumeration
        if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_ENUMERATION) == 0 && (fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_ENUMERATION) != 0) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_ENUMERATION;
            fEnumeration = fBase.fEnumeration;
            fEnumerationSize = fBase.fEnumerationSize;
            enumerationAnnotations = fBase.enumerationAnnotations;
        ...
        if ((( fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0) &&
                !((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0) && !((fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0)) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE;
            fMaxExclusive = fBase.fMaxExclusive;
            maxExclusiveAnnotation = fBase.maxExclusiveAnnotation;
        }
        ...
        if ((( fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0) &&
                !((fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0) && !((fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_MINEXCLUSIVE;
            fMinExclusive = fBase.fMinExclusive;
            minExclusiveAnnotation = fBase.minExclusiveAnnotation;
        }
        ...
        if ((( fBase.fFacetsDefined & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0)
                && !((fFacetsDefined & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0)) {
            fFacetsDefined |= XSSimpleTypeDefinition.FACET_FRACTIONDIGITS;
            fFractionDigits = fBase.fFractionDigits;
            fractionDigitsAnnotation = fBase.fractionDigitsAnnotation;
        }
    ...
    public void validate(ValidationContext context, ValidatedInfo validatedInfo)
        ...
        if (context.needFacetChecking() &&
                (fFacetsDefined != 0 && fFacetsDefined != XSSimpleTypeDefinition.FACET_WHITESPACE)) {
    ...
    private void checkFacets(ValidatedInfo validatedInfo) throws InvalidDatatypeValueException {
        ...
        //enumeration
        if ( ((fFacetsDefined & XSSimpleTypeDefinition.FACET_ENUMERATION) != 0 ) ) {
        ...
        //maxinclusive
        if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0 ) {
        ...
        //maxExclusive
        if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0 ) {
        ...
        //minInclusive
        if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0 ) {
        ...
        //minExclusive
        if ( (fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0 ) {
    ...
    private void checkExtraRules(ValidationContext context, ValidatedInfo validatedInfo) throws InvalidDatatypeValueException {
        ...
        if (fVariety == XSSimpleTypeDefinition.VARIETY_ATOMIC) {

            fDVs[fValidationDV].checkExtraRules(ob, context);

        } else if (fVariety == XSSimpleTypeDefinition.VARIETY_LIST) {

            ListDV.ListData values = (ListDV.ListData)ob;
            XSSimpleType memberType = validatedInfo.memberType;
            int len = values.getLength();
            try {
                if (fItemType.fVariety == XSSimpleTypeDefinition.VARIETY_UNION) {
    ...
    throws InvalidDatatypeValueException{
        ...
        if (fVariety == XSSimpleTypeDefinition.VARIETY_ATOMIC) {
            ...
            boolean isUnion = fItemType.getVariety() == XSSimpleTypeDefinition.VARIETY_UNION;
            ...
            for(int i = 0 ; i < countOfTokens ; i ++){
                ...
                if (context.needFacetChecking() &&
                        (fItemType.fFacetsDefined != 0 && fItemType.fFacetsDefined != XSSimpleTypeDefinition.FACET_WHITESPACE)) {
            ...
            for (int i = 0; i < fMemberTypes.length; i++) {
                try {
                    ...
                    if (context.needFacetChecking() &&
                            (fMemberTypes[i].fFacetsDefined != 0 && fMemberTypes[i].fFacetsDefined != XSSimpleTypeDefinition.FACET_WHITESPACE)) {
    ...
    public short getDefinedFacets() {
        ...
        if (fPatternType != SPECIAL_PATTERN_NONE) {
            return (short)(fFacetsDefined | XSSimpleTypeDefinition.FACET_PATTERN);
        }
        if (fValidationDV == DV_INTEGER) {
            return (short)(fFacetsDefined | XSSimpleTypeDefinition.FACET_PATTERN | XSSimpleTypeDefinition.FACET_FRACTIONDIGITS);
        }
    ...
    public short getFixedFacets() {
        if (fValidationDV == DV_INTEGER)
            return (short)(fFixedFacet | XSSimpleTypeDefinition.FACET_FRACTIONDIGITS);
        return fFixedFacet;
    }
    ...
    private void setOrdered(){
        ...
        // 2. If every member of {member type definitions} has a {value} of false for the ordered facet, then {value} is false.
        else if(fVariety == XSSimpleTypeDefinition.VARIETY_UNION){
            ...
            boolean allFalse = fMemberTypes[0].fOrdered == XSSimpleTypeDefinition.ORDERED_FALSE;
            ...
            for (int i = 1; i < fMemberTypes.length && (commonAnc || allFalse); i++) {
                ...
                if (allFalse)
                    allFalse = fMemberTypes[i].fOrdered == XSSimpleTypeDefinition.ORDERED_FALSE;
            }
            if (commonAnc) {
    ...
    private void setBounded(){
        if(fVariety == XSSimpleTypeDefinition.VARIETY_ATOMIC){
            if( (((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0)  || ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0))
                    &&  (((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0)  || ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0)) ){
                this.fBounded = true;
            }
            else{
                this.fBounded = false;
            ...
            if( ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 ) || ( ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0 )
                    &&  ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 )) ){
                this.fBounded = true;
            }
            else{
                this.fBounded = false;
    ...
    private void setCardinality(){
        if(fVariety == XSSimpleTypeDefinition.VARIETY_ATOMIC){
            if(fBase.fFinite){
                ...
                if ( ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_LENGTH) != 0 ) || ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0 )
                        || ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0 ) ){
                    this.fFinite = true;
                }
                else if( (((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0 ) || ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0 ))
                        && (((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0 ) || ((this.fFacetsDefined & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0 )) ){
    ...
    private boolean isDerivedByAny(String ancestorNS, String ancestorName,
        ...
        while (type != null && type != oldType)  {
            ...
            if (((XSSimpleTypeDecl) type).getVariety() == XSSimpleTypeDefinition.VARIETY_ABSENT
                    || ((XSSimpleTypeDecl) type).getVariety() == XSSimpleTypeDefinition.VARIETY_ATOMIC) {
                type = type.getBaseType();
            } else if (((XSSimpleTypeDecl) type).getVariety() == XSSimpleTypeDefinition.VARIETY_UNION) {
            ...
            } else if (((XSSimpleTypeDecl) type).getVariety() == XSSimpleTypeDefinition.VARIETY_LIST) {
    ...
    private boolean isDerivedByList (String ancestorNS, String ancestorName, XSTypeDefinition type) {
        ...
        if (type !=null && ((XSSimpleTypeDefinition)type).getVariety() == XSSimpleTypeDefinition.VARIETY_LIST) {
    ...
    private boolean isDerivedByUnion (String ancestorNS, String ancestorName, XSTypeDefinition type) {
        ...
        // If the variety is union
        if (type !=null && ((XSSimpleTypeDefinition)type).getVariety() == XSSimpleTypeDefinition.VARIETY_UNION) {
    ...
    static final XSSimpleTypeDecl fAnySimpleType = new XSSimpleTypeDecl(null, "anySimpleType", DV_ANYSIMPLETYPE, XSSimpleTypeDefinition.ORDERED_FALSE, false, true, false, true, XSConstants.ANYSIMPLETYPE_DT);

    static final XSSimpleTypeDecl fAnyAtomicType = new XSSimpleTypeDecl(fAnySimpleType, "anyAtomicType", DV_ANYATOMICTYPE, XSSimpleTypeDefinition.ORDERED_FALSE, false, true, false, true, XSSimpleTypeDecl.ANYATOMICTYPE_DT);
    ...
    public XSObjectList getFacets() {
        if (fFacets == null &&
            ...
            int count = 0;
            if ((fFacetsDefined & XSSimpleTypeDefinition.FACET_WHITESPACE) != 0 &&
                ...
                facets[count] =
                    new XSFacetImpl(
                            ...
                            0,
                            null,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_WHITESPACE) != 0,
            ...
            if (fLength != -1) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            fLength,
                            null,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_LENGTH) != 0,
                            lengthAnnotation);
                count++;
            }
            if (fMinLength != -1) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            fMinLength,
                            null,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_MINLENGTH) != 0,
                            minLengthAnnotation);
                count++;
            }
            if (fMaxLength != -1) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            fMaxLength,
                            null,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_MAXLENGTH) != 0,
                            maxLengthAnnotation);
                count++;
            }
            if (fTotalDigits != -1) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            fTotalDigits,
                            null,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_TOTALDIGITS) != 0,
            ...
            if (fValidationDV == DV_INTEGER) {
                ...
                facets[count] =
                    new XSFacetImpl(
                            ...
                            fFractionDigits,
                            null,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_FRACTIONDIGITS) != 0,
                            fractionDigitsAnnotation);
                count++;
            }
            if (fMaxInclusive != null) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            0,
                            fMaxInclusive,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_MAXINCLUSIVE) != 0,
            ...
            if (fMaxExclusive != null) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            0,
                            fMaxExclusive,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_MAXEXCLUSIVE) != 0,
            ...
            if (fMinExclusive != null) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            0,
                            fMinExclusive,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_MINEXCLUSIVE) != 0,
            ...
            if (fMinInclusive != null) {
                facets[count] =
                    new XSFacetImpl(
                            ...
                            0,
                            fMinInclusive,
                            (fFixedFacet & XSSimpleTypeDefinition.FACET_MININCLUSIVE) != 0,
    ...
    public XSObjectList getMultiValueFacets() {
        if (fMultiValueFacets == null &&
                ((fFacetsDefined & XSSimpleTypeDefinition.FACET_ENUMERATION) != 0 ||
                        (fFacetsDefined & XSSimpleTypeDefinition.FACET_PATTERN) != 0 ||
                        fPatternType != SPECIAL_PATTERN_NONE ||
    ...
    private static final class XSFacetImpl implements XSFacet {
        ...
        public Object getActualFacetValue() {
            if (avalue == null) {
                if (kind == XSSimpleTypeDefinition.FACET_WHITESPACE) {
                    avalue = svalue;
                }
                else {
