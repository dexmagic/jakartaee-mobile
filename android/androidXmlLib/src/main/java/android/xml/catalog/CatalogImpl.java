...
class CatalogImpl extends GroupEntry implements Catalog {
    ...
    private void init(CatalogFeatures f) {
        ...
        setPrefer(features.get(CatalogFeatures.Feature.PREFER));
        setDeferred(features.get(CatalogFeatures.Feature.DEFER));
        setResolve(features.get(CatalogFeatures.Feature.RESOLVE));
    }
    ...
    public final void setDeferred(String value) {
        isDeferred = CatalogFeatures.DEFER_TRUE.equals(value);
    }
