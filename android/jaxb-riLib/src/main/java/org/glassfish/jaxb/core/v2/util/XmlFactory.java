...
public class XmlFactory {
    ...
    public static SchemaFactory allowExternalAccess(SchemaFactory sf, String value, boolean disableSecureProcessing) {
        ...
        try {
            sf.setProperty(android.xml.XMLConstants.ACCESS_EXTERNAL_SCHEMA, value);
            if (LOGGER.isLoggable(Level.FINE)) {
                LOGGER.log(Level.FINE, Messages.JAXP_SUPPORTED_PROPERTY.format(android.xml.XMLConstants.ACCESS_EXTERNAL_SCHEMA));
            }
        } catch (SAXException se) {
            // nothing to do; support depends on version JDK or SAX implementation
            if (LOGGER.isLoggable(Level.CONFIG)) {
                LOGGER.log(Level.CONFIG, Messages.JAXP_UNSUPPORTED_PROPERTY.format(android.xml.XMLConstants.ACCESS_EXTERNAL_SCHEMA), se);
            }
        }
        return sf;
    }
    ...
    public static SchemaFactory allowExternalDTDAccess(SchemaFactory sf, String value, boolean disableSecureProcessing) {
        ...
        try {
            sf.setProperty(android.xml.XMLConstants.ACCESS_EXTERNAL_DTD, value);
            if (LOGGER.isLoggable(Level.FINE)) {
                LOGGER.log(Level.FINE, Messages.JAXP_SUPPORTED_PROPERTY.format(android.xml.XMLConstants.ACCESS_EXTERNAL_DTD));
            }
        } catch (SAXException se) {
            // nothing to do; support depends on version JDK or SAX implementation
            if (LOGGER.isLoggable(Level.CONFIG)) {
                LOGGER.log(Level.CONFIG, Messages.JAXP_UNSUPPORTED_PROPERTY.format(android.xml.XMLConstants.ACCESS_EXTERNAL_DTD), se);
            }
        }
        return sf;
    }
